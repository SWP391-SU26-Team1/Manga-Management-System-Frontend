...
export const reviewSessionApi = {
  ...
  finalize: (sessionId) =>
    api.post(`${ADMIN_REVIEW_SESSIONS_ENDPOINT}/${sessionId}/finalize`).then((response) => unwrap(response.data)),
  getResult: (sessionId) =>
    api.get(`${ADMIN_REVIEW_SESSIONS_ENDPOINT}/${sessionId}/result`).then((response) => unwrap(response.data)),
  applyDecision: (sessionId, body) =>
    api.patch(`${ADMIN_REVIEW_SESSIONS_ENDPOINT}/${sessionId}/apply-decision`, body).then((response) => unwrap(response.data)),
