...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      // Fallback to Assistant mock data if not found
      loadedProfile = MOCK_USERS.find(u => u.role === 'ASSISTANT')
    }
  ...
  const userInitials = profile.fullName === 'Kenji Tanaka' 
    ? 'KT' 
    : (profile.fullName.split(' ').pop()?.slice(0, 2).toUpperCase() || 'KT')
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white border-4 border-manga-ink p-4 flex flex-col items-center text-center shadow-[4px_4px_0px_rgba(0,0,0,1)]">
              ...
              <span className="text-xs font-bold uppercase text-gray-500 mt-1">Nhiệm vụ đang làm</span>
            </div>
            <div className="bg-white border-4 border-manga-ink p-4 flex flex-col items-center text-center shadow-[4px_4px_0px_rgba(0,0,0,1)]">
          ...
          <div className="bg-white border-4 border-manga-ink p-6 shadow-[6px_6px_0px_rgba(0,0,0,1)]">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 border-l-4 border-manga-red pl-4 py-1">
                ...
                <div>
                  <p className="font-bold text-sm">Hoàn thành vẽ Lineart - Task #1035</p>
              ...
              <div className="flex items-start gap-4 border-l-4 border-gray-300 pl-4 py-1">
                ...
                <div>
                  <p className="font-bold text-sm text-gray-600">Nộp bản phác thảo bối cảnh - Task #1038</p>
              ...
              <div className="flex items-start gap-4 border-l-4 border-gray-300 pl-4 py-1">
                <div className="w-2 h-2 rounded-full bg-gray-300 mt-1.5 -ml-[23px]"></div>
                <div>
                  <p className="font-bold text-sm text-gray-600">Đã chỉnh sửa bản thảo theo yêu cầu của Mangaka</p>
