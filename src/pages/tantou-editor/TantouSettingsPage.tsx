...
import { Bell, Palette, Shield, Globe, Save } from 'lucide-react'
  ...
  return (
    <div className="max-w-4xl mx-auto pb-16 font-sans">
      ...
      <div className="mb-8 flex justify-between items-end">
        <div>
          ...
          <p className="text-sm font-bold text-gray-500">
            Tùy chỉnh trải nghiệm và cấu hình tài khoản editor của bạn
          </p>
        </div>
      ...
      <footer className="mt-16 pt-8 border-t-2 border-manga-ink flex flex-col md:flex-row items-center justify-between gap-4 text-sm font-bold text-gray-500">
        <div className="font-manga text-2xl text-manga-red font-bold">MangaFlow</div>
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="#" className="hover:text-manga-red transition-colors">Hỗ trợ Editor</a>
        </div>
      </footer>
    </div>
  )
