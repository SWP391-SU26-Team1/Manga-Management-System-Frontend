      ...
      <div className="mb-8 flex justify-between items-end">
        <div>
          ...
          <p className="text-sm font-bold text-gray-500">
            Tùy chỉnh trải nghiệm và cấu hình tài khoản trợ lý của bạn
          </p>
        </div>
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between p-3 bg-gray-50 border-2 border-manga-ink shadow-[2px_2px_0px_rgba(0,0,0,1)] cursor-pointer hover:bg-red-50/20 transition-colors">
              <div>
                ...
                <span className="text-xs text-gray-500 font-semibold">Nhận email cập nhật khi có nhiệm vụ mới từ Mangaka</span>
              </div>
              <input 
                type="checkbox" 
                checked={emailNotif} 
            ...
            <label className="flex items-center justify-between p-3 bg-gray-50 border-2 border-manga-ink shadow-[2px_2px_0px_rgba(0,0,0,1)] cursor-pointer hover:bg-red-50/20 transition-colors">
              <div>
                ...
                <span className="text-xs text-gray-500 font-semibold">Đẩy thông báo thời gian thực về bình luận và chỉnh sửa</span>
              </div>
              <input 
                type="checkbox" 
                checked={pushNotif} 
            ...
            <div className="grid grid-cols-3 gap-4">
              {['light', 'dark', 'manga'].map(mode => (
                <button
                  ...
                  className={`p-3 border-2 border-manga-ink font-bold text-xs uppercase transition-all shadow-[2px_2px_0px_rgba(0,0,0,1)] cursor-pointer ${
                    theme === mode 
        ...
        <div className="bg-white border-4 border-manga-ink p-6 shadow-[6px_6px_0px_rgba(0,0,0,1)]">
          ...
          <label className="flex items-center justify-between p-3 bg-gray-50 border-2 border-manga-ink shadow-[2px_2px_0px_rgba(0,0,0,1)] cursor-pointer hover:bg-red-50/20 transition-colors">
            <div>
              ...
              <span className="text-xs text-gray-500 font-semibold">Cho phép các Mangaka khác tìm thấy bạn trong hệ thống tìm trợ lý</span>
            </div>
            <input 
              type="checkbox" 
